...
class SDGNN_SGC(nn.Module):
    ...
    def forward(self, edge_index, features_tensor, device):
        ...
        # 4. 社区聚合 (新图)
        enhanced_feats = gnn_first_layer_aggregation(G_new, propagated_feats, self.activation, device, community_cache)
...
if __name__ == "__main__":
    ...
    df.to_excel("1OURS_results6_sgc_sdc_gpu.xlsx", index=False)
    print("已保存结果")
